...
# ./pypiUploadVer DID NOT exist -- forPypiVersion=0.22 -- forLocalVersion=0.1 -- constant=NA
def pkgVersion():
        return '0.1'
...
####+BEGIN: b:py3:pypi:setup/requires :extras ("pygobject==3.50.0")
